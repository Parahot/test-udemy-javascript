...
// 36. урок Основы ООП (объектно-ориентированное программирование), прототипно-ориентированное наследование (это частный случай ООП)

// есть общие даннные солдата
const soldier = {
    helth: 400,
    armor: 100,
    sayHello: function() {
...
// 1. вариант
// есть конкретный содат
const john = {
    helth:200
};
// чтобы унаследовать джону все свойства от общих данных
// есть устаревший способ
john.__proto__ = soldier;
// но лучше современный, аналогичный то что выше
Object.setPrototypeOf(john, soldier);
// в итоге получается:
console.log(john); // helth: 200
console.log(john.armor); // 100 , т.е. унаследовал от общего прототипа
john.sayHello(); // Hello , т.е тоже умеет это делать благодаря прототипу
// 2. вариант
// но обычно делают по другому - сразу создают джона с прототипным наследованием от общего солдата
...
// Упражнение по написанию кода 15
const restorantData = {
    menu: [
        {
            name: 'Salad Caesar',
...
function transferWaitors(data) {
    ...
    //const copy2 = Object.create(copy);
